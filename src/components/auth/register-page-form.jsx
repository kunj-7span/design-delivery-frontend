...
const RegisterPageForm = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            setError("root", { type: "server", message: "Failed to register. Email might already exist." });
        }
    };
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className='w-full' noValidate>
            ...
            <div className='flex flex-col gap-3'>
                ...
                <InputField
                    label={accountType === "agency" ? "Agency Name" : "Client Name"}
                    id="name"
                    type="text"
                    icon={accountType === "agency" ? Building2 : User}
                    placeholder={accountType === "agency" ? "Agency name" : "Client name"}
                ...
                <InputField
                    ...
                    type="email"
                    icon={Mail}
                    placeholder={accountType === "agency" ? "Agency email" : "Client email"}
                    autoComplete="email"
                    error={errors.email}
                    {...register("email")}
                />
